...
##---------------------------------------REFERENCE---------------------------------------##
#execute if data storage teplus:tech_anvil.ui {ResultItem:{id:"modded:sword_id1"}} run item modify entity @s container.22 complement:attack_speed/sword1
#execute if data storage teplus:tech_anvil.ui {ResultItem:{id:"modded:sword_id2"}} run item modify entity @s container.22 complement:attack_speed/sword2
#execute if data storage teplus:tech_anvil.ui {ResultItem:{id:"modded:sword_id3"}} run item modify entity @s container.22 complement:attack_speed/sword3
##---------------------------------------------------------------------------------------##
